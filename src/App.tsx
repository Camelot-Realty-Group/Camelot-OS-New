...
const PostcardMailer = lazy(() => import('@/pages/PostcardMailer'));
...
const Pitch382Lafayette = lazy(() => import('@/pages/Pitch382Lafayette'));
    ...
    <>
      ...
      <Layout onStartTour={startTour}>
        <Routes>
          ...
          <Route path="/postcard-mailer" element={page(PostcardMailer)} />
          ...
          <Route path="/pitch/382-lafayette-street" element={page(Pitch382Lafayette)} />
